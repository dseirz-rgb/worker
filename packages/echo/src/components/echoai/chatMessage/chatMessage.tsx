...
import { TeaserReferencesSection, constructAllReferences } from '../referencePanel';
      ...
      >
        <div className={`${isAI ? `border-l-4 ${borderColor} pl-4` : ''}`}>
          ...
          {isAI && (() => {
            ...
            const hasReferences = 
              references.notesReferenceCardData.length > 0 ||
              references.onlineReferenceCardData.length > 0 ||
              references.codeReferenceCardData.length > 0;
            
            if (!hasReferences) return null;
            
            return (
              <TeaserReferencesSection
                notesReferenceCardData={references.notesReferenceCardData}
                onlineReferenceCardData={references.onlineReferenceCardData}
                codeReferenceCardData={references.codeReferenceCardData}
