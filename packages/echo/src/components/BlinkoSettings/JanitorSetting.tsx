          ...
          <CardBody className="space-y-6">
            ...
            <div className="bg-default-50 rounded-lg p-4 space-y-2">
              ...
              <div className="text-sm text-foreground/70 space-y-1">
                ...
                <p>2. 进入 <code className="bg-default-100 px-1 rounded">services/janitor/janitor</code> 目录</p>
                <p>3. 运行 <code className="bg-default-100 px-1 rounded">python server.py</code></p>
              </div>
              <p className="text-xs text-foreground/50 mt-2">
                提示: 也可以使用 Docker Compose 启动，配置文件位于 services/janitor/docker-compose.janitor.yml
              </p>
            </div>
          </CardBody>
        </Card>
